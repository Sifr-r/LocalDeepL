...
Phase 1 ships a single provider — the in-process OCR job queue. Future
phases add providers for the rest of the capability seams (state, auth,
document export, glossary import, provider manager, telemetry, etc.).
"""
...
__all__ = ["local_job_queue_provider"]
