...
appeared on the old ``local_deepl/core/grounded.py`` module so the
test suite (``tests/test_grounded.py``), the public root
``local_deepl/__init__.py``, and downstream callers (pipeline,
...
from local_deepl.core.grounded.prompted import (
    DEFAULT_GROUNDING_PROMPT,
    PromptedGroundedOCR,
)
from local_deepl.core.grounded.rasterize import _rasterize_to_jpeg_pages
