...
2. Run the existing :func:`local_deepl.api.routers.ocr._run_ocr_pipeline`
...
from local_deepl.api.routers.websocket import ConnectionManagerLike
...
def _default_chunk_pages() -> int:
    ...
    raw = os.environ.get("LOCAL_DEEPL_CHUNK_PAGES", "25")
    try:
        value = int(raw)
...
async def run_ocr_in_chunks(
    *,
    ...
    from local_deepl.api.routers.ocr import (
