...
- [common.py](file://src/omniscribe/api/routers/common.py)
- [requests.py](file://src/omniscribe/api/schemas/requests.py)
...
- [document_metadata.py](file://src/omniscribe/api/services/document_metadata.py)
- [document_exports.py](file://src/omniscribe/api/services/document_exports.py)
- [tree_artifact.py](file://src/omniscribe/api/services/tree_artifact.py)
- [ocr_pipeline_factory.py](file://src/omniscribe/api/services/ocr_pipeline_factory.py)
- [ocr_response.py](file://src/omniscribe/api/services/ocr_response.py)
...
- [core/translation_config.py](file://src/omniscribe/core/translation_config.py)
- [core/llm_client.py](file://src/omniscribe/core/llm_client.py)
...
- [core/ocr/filters.py](file://src/omniscribe/core/ocr/filters.py)
- [core/ocr/prompts.py](file://src/omniscribe/core/ocr/prompts.py)
- [core/grounded/models.py](file://src/omniscribe/core/grounded/models.py)
- [core/grounded/parsers.py](file://src/omniscribe/core/grounded/parsers.py)
- [core/grounded/prompted.py](file://src/omniscribe/core/grounded/prompted.py)
- [core/grounded/rasterize.py](file://src/omniscribe/core/grounded/rasterize.py)
...
- [core/docx_writer.py](file://src/omniscribe/core/docx_writer.py)
- [core/docx_tree_writer.py](file://src/omniscribe/core/docx_tree_writer.py)
- [core/html_writer.py](file://src/omniscribe/core/html_writer.py)
- [core/tree_export.py](file://src/omniscribe/core/tree_export.py)
...
## Update Summary
**Changes Made**
- Updated all file references from `local_deepl` to `omniscribe` package structure
- Revised import paths and module organization throughout the architecture documentation
- Updated component descriptions to reflect the new package naming convention
- Maintained all architectural concepts while adapting to the restructured codebase
...
**Diagram sources**
- [server.py](file://src/omniscribe/server.py)
- [api/routers/websocket.py](file://src/omniscribe/api/routers/websocket.py)
- [api/routers/jobs.py](file://src/omniscribe/api/routers/jobs.py)
- [api/routers/translation.py](file://src/omniscribe/api/routers/translation.py)
- [api/routers/ocr.py](file://src/omniscribe/api/routers/ocr.py)
- [api/routers/artifacts.py](file://src/omniscribe/api/routers/artifacts.py)
- [api/routers/config.py](file://src/omniscribe/api/routers/config.py)
- [api/routers/state.py](file://src/omniscribe/api/routers/state.py)
- [api/routers/common.py](file://src/omniscribe/api/routers/common.py)
- [api/services/security_middleware.py](file://src/omniscribe/api/services/security_middleware.py)
- [api/celery_app.py](file://src/omniscribe/api/celery_app.py)
- [api/tasks.py](file://src/omniscribe/api/tasks.py)
- [core/block_tree.py](file://src/omniscribe/core/block_tree.py)
- [core/ocr/processor.py](file://src/omniscribe/core/ocr/processor.py)
- [core/ocr/filters.py](file://src/omniscribe/core/ocr/filters.py)
- [core/aligner.py](file://src/omniscribe/core/aligner.py)
...
- [api/routers/config.py](file://src/omniscribe/api/routers/config.py)
- [api/routers/state.py](file://src/omniscribe/api/routers/state.py)
- [api/services/workflow.py](file://src/omniscribe/api/services/workflow.py)
- [api/services/progress.py](file://src/omniscribe/api/services/progress.py)
- [api/services/security_middleware.py](file://src/omniscribe/api/services/security_middleware.py)
- [api/services/security_config.py](file://src/omniscribe/api/services/security_config.py)
- [api/services/ai.py](file://src/omniscribe/api/services/ai.py)
- [api/services/document_metadata.py](file://src/omniscribe/api/services/document_metadata.py)
- [api/services/document_exports.py](file://src/omniscribe/api/services/document_exports.py)
- [api/services/tree_artifact.py](file://src/omniscribe/api/services/tree_artifact.py)
- [api/services/ocr_pipeline_factory.py](file://src/omniscribe/api/services/ocr_pipeline_factory.py)
- [api/services/ocr_response.py](file://src/omniscribe/api/services/ocr_response.py)
- [api/services/ocr_settings.py](file://src/omniscribe/api/services/ocr_settings.py)
- [core/block_tree.py](file://src/omniscribe/core/block_tree.py)
- [core/document.py](file://src/omniscribe/core/document.py)
- [core/preprocessing.py](file://src/omniscribe/core/preprocessing.py)
- [core/postprocess.py](file://src/omniscribe/core/postprocess.py)
