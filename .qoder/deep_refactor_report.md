...
These "Partial" findings are still **open** (not yet mitigated). §1.1 and §4.1 used to be on this list but have been promoted to "Partial — mitigated" — see the **Mitigated (audit-defense follow-ups)** table below for the 2026-08-12 audit-defense paragraphs.

- 1.2 — companion to mitigated §1.1; claim of "4× decodes" overstated; per-page max is 3, not 4
