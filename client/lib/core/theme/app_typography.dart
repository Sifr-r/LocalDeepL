...
/// 1. Display: Fraunces (Headings h1-h3, modal titles, stats)
/// 2. Body: Sora (All body copy, buttons, inputs, labels)
/// 3. Mono: JetBrains Mono (Artifact IDs, hashes, tokens, file sizes)
class AppTypography {
  AppTypography._();
  ...
  static TextStyle titleLarge({Color? color}) => GoogleFonts.sora(
        fontSize: 16,
        fontWeight: FontWeight.w600,
        height: 24 / 16,
        letterSpacing: -0.1,
  ...
  static TextStyle titleMedium({Color? color}) => GoogleFonts.sora(
        fontSize: 14,
        fontWeight: FontWeight.w600,
        height: 20 / 14,
        color: color,
  ...
  static TextStyle titleSmall({Color? color}) => GoogleFonts.sora(
        fontSize: 13,
        fontWeight: FontWeight.w600,
        height: 18 / 13,
        color: color,
  ...
  static TextStyle bodyLarge({Color? color}) => GoogleFonts.sora(
        fontSize: 15,
  ...
  static TextStyle bodyMedium({Color? color}) => GoogleFonts.sora(
        fontSize: 14,
        fontWeight: FontWeight.w400,
        height: 20 / 14,
        color: color,
  ...
  static TextStyle bodyMediumStrong({Color? color}) => GoogleFonts.sora(
        fontSize: 14,
  ...
  static TextStyle bodySmall({Color? color}) => GoogleFonts.sora(
        fontSize: 12,
        fontWeight: FontWeight.w400,
        height: 16 / 12,
        color: color,
  ...
  static TextStyle captionStrong({Color? color}) => GoogleFonts.sora(
        fontSize: 12,
        fontWeight: FontWeight.w500,
        height: 16 / 12,
        color: color,
  ...
  static TextStyle labelLarge({Color? color}) => GoogleFonts.sora(
        fontSize: 14,
        fontWeight: FontWeight.w500,
        height: 20 / 14,
        letterSpacing: 0.1,
  ...
  static TextStyle labelMedium({Color? color}) => GoogleFonts.sora(
        fontSize: 12,
        fontWeight: FontWeight.w500,
        height: 16 / 12,
        color: color,
  ...
  static TextStyle micro({Color? color}) => GoogleFonts.sora(
        fontSize: 10,
        fontWeight: FontWeight.w600,
        height: 14 / 10,
        letterSpacing: 1.2,
  ...
  static TextStyle codeBold({Color? color}) => GoogleFonts.jetBrainsMono(
        fontSize: 12,
        fontWeight: FontWeight.w600,
        height: 16 / 12,
        color: color,
